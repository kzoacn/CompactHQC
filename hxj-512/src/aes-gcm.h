...
#define GCM_BLOCK_SIZE  AES_BLOCK_SIZE       /* block size in bytes */
...
// typedef int (*block_encrypt_p)(const uint32_t rk[SM4_KEY_SCHEDULE], const uint8_t* input, uint8_t* output);
...
/*
operation_result gcm_crypt_init(void* context,
